...
public class JButtonTableExample {
    public JButtonTableExample() {
        ...
        table.getColumn("Button").setCellRenderer((TableCellRenderer) new ButtonRenderer());
        table.getColumn("Button").setCellEditor((TableCellEditor) new ButtonEditor(new JCheckBox()));
